...
class StudentService extends __BaseService {
  ...
  static readonly putStudentPath = '/Student';
   ...
   * @param body undefined
   */
  putStudentResponse(body?: StudentEditForm): __Observable<__StrictHttpResponse<null>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = body;
   ...
   * @param body undefined
   */
  putStudent(body?: StudentEditForm): __Observable<null> {
    return this.putStudentResponse(body).pipe(
